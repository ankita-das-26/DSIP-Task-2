  ...
  <div class="forms">
    <div class="signup-form">
      <form action="./logic/login.php" method="post" class="form-group">
        ...
        <input type="email" placeholder="E-mail" name="email" class="form-control inp-email mt-2">

        <input type="password" placeholder="Password" name="pwd" class="form-control inp-pwd mt-2">
